...
var table = $("#example2").DataTable({
    ...
    serverSide: true,
    processing: false,
    ajax: "/admin/draftMou/getDatadraftMouByMitra/admin4",
    columns: [
        {
            data: "DT_RowIndex",
            name: "DT_RowIndex",
        ...
        { data: "nomorMouMitra", name: "nomorMouMitra" },
        { data: "nomorMouUdb", name: "nomorMouUdb" },
        { data: "tanggalPembuatan", name: "tanggalPembuatan" },
        { data: "tanggalExpired", name: "tanggalExpired" },
        { data: "file", name: "file" },
...
function showTambahUser() {
    clearField();
    $("#modalTambahDraftMou").modal("show");
}
